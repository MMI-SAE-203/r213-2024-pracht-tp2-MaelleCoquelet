    ...
    <div
        ...
        <div
            ...
            <svg width="303" height="2" viewBox="0 0 303 2" fill="none" xmlns="http://www.w3.org/2000/svg"
                ...
                <line y1="1.25" x2="303" y2="1.25" stroke="#E0E7FF" stroke-width="1.5"></line>
            </svg>
            <div class="flex justify-center items-center self-stretch flex-grow-0 flex-shrink-0 gap-1.5">
                ...
                <div class="flex justify-center items-center flex-grow relative gap-2">
                    <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg"
                        class="flex-grow-0 flex-shrink-0 w-5 h-5 relative" preserveAspectRatio="xMidYMid meet">
                        <g clip-path="url(#clip0_32955_1614)">
                            <path
                ...
                <div class="flex justify-end items-center flex-grow relative gap-2">
                    <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg"
                        ...
                        <g clip-path="url(#clip0_32955_1622)">
                            <path
                                d="M8.83161 15.5437L3.45643 10.1685C2.84802 9.56011 2.84802 8.43989 3.45643 7.83148L8.83161 2.45631C9.44001 1.8479 10.5602 1.8479 11.1686 2.45631L16.5438 7.83148C17.1522 8.43989 17.1522 9.56011 16.5438 10.1685L11.1686 15.5437C10.5602 16.1521 9.44001 16.1521 8.83161 15.5437V15.5437Z"
                                stroke="#6366F1" stroke-width="1.66667" stroke-linecap="round" stroke-linejoin="round">
                            </path>
